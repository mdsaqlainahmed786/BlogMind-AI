      ...
      <div className="flex items-center justify-between mx-auto w-full max-w-screen-xl">
        ...
        <div className="flex items-center cursor-pointer space-x-2">
          <Brain
            className={`h-8 w-8 transition-colors duration-300 ${
              scrolled ? "text-blue-400 bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600" : "text-white"
            }`}
          />
          <span
            className={`text-2xl font-bold transition-all duration-300 ${
              scrolled ? "text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600" : "text-white"
            }`}
          >
            BlogMind AI
          </span>
        ...
        <div className="flex items-center gap-6 z-10">
          ...
          <div className="relative group">
            ...
            <div
              className="absolute right-0 top-15 w-48 bg-white/10 backdrop-blur-md rounded-lg shadow-lg py-2 z-10 opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-200"
            >
